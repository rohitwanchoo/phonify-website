...
<template>
  ...
  <div class="grid grid-cols-[66.6667%_33.3333%] gap-2 h-full">
    <!-- Left Side (Main Section with Tabs) -->
    <div class="h-full rounded border ">
      <Tabs default-value="account" class="h-full" orientation="vertical">
        <div class="grid grid-cols-[40%_60%] h-full">
          <!-- Tab Triggers (30%) -->
          <TabsList class="py-3 px-4">
            <TabsTrigger value="account" class="text-left h-14 px-4 w-full block mx-auto mb-2 ">
              <Icon name="icons:dashboard" /> Edit Profile
            </TabsTrigger>
            <TabsTrigger value="password" class="text-left h-14 px-4 w-full block mx-auto mb-2">
              <Icon name="icons:dashboard" />Change Password
            </TabsTrigger>
            <TabsTrigger value="voicemail" class="text-left h-14 px-4 w-full block mx-auto mb-2">
              <Icon name="icons:dashboard" /> Voicemail Drop
            </TabsTrigger>
            <TabsTrigger value="aireplies" class=" text-left h-14 px-4 w-full block mx-auto mb-2">
