...
<template>
      ...
      <div class="bg-white p-5 grid grid-cols-3 gap-x-4 gap-y-3 rounded-b-lg">
        <div v-for="(item, index) in data" :key="index" class="flex flex-col gap-2">
          ...
          <div class="flex items-center gap-2">
            ...
            <Icon
              v-if="item.copy" name="lucide:copy" size="16" class="cursor-pointer"
  ...
  <div class="p-5 flex gap-4 justify-between bg-white shadow-md overflow-x-auto">
    ...
    <Button variant="outline" name="dial-pad" class="w-full flex-1 cursor-pointer">
      <Icon name="material-symbols:dialpad" size="20" />
      Dial-pad
    </Button>
    <Button variant="destructive" name="hangup" class="w-full flex-1 cursor-pointer">
