...
const props = defineProps<{
  showShortDialer?: boolean
}>()

const emit = defineEmits<{
  (e: 'call', phoneNumber: string, countryCode: string): void
  (e: 'hangup'): void
  (e: 'close'): void
}>()
...
const shortDialer = ref(props.showShortDialer || false)
...
const dialerRef = ref<HTMLElement>()
