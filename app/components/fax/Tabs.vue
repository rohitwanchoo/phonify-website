...
<template>
  <BaseHeader class="text-primary" orientation="vertical" />

  <div class="lg:flex gap-2 lg:h-full mt-7">
    <!-- Left Side -->
    <div class="lg:h-full lg:w-[100%] mb-4 md:mb-0 rounded-lg border">
      <Tabs v-model="currentTab" class="h-full" orientation="vertical">
        <div class="flex flex-col lg:flex-row h-full">
          ...
          <!-- Tab Content -->
          <div class="lg:w-[100%] flex flex-col h-full max-h-[calc(100vh-138px)]">
