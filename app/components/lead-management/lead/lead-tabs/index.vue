    ...
    <Tabs default-value="activity" class="w-full gap-0">
      <div class=" border-b pb-4 p-4">
        <TabsList class="grid w-full grid-cols-4 p-0">
          <TabsTrigger value="activity" class="data-[state=active]:bg-black data-[state=active]:text-[#FAFAFA] font-light">
            <p>Activity</p>
          </TabsTrigger>
          <TabsTrigger value="text" class="data-[state=active]:bg-black data-[state=active]:text-white font-light">
            <p>Send Text</p>
          </TabsTrigger>
          <TabsTrigger value="email" class="data-[state=active]:bg-black data-[state=active]:text-white font-light">
            <p>Send Email</p>
          </TabsTrigger>
          <TabsTrigger value="fax" class="data-[state=active]:bg-black data-[state=active]:text-white font-light">
            <p>Send Fax</p>
          </TabsTrigger>
        </TabsList>
      </div>
